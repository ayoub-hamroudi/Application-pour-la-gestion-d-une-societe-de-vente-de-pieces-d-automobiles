...
class CustomerDetails extends JFrame implements ActionListener
{
	...
	public CustomerDetails()
	{
		...
		// initialisation des elements sur le cadre
		...
		// ajouter les noms des clients a la liste
		try
		{
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(ae.getSource() == bViewBill)
		{
			...
			String sTemp[] = var.sCustomerName.spl(" ");
			if(sTemp.length == 3)
